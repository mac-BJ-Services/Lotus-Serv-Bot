...
exports.privaterooms = ['bjsworld', 'pisceansocean', 'kafkasemporium', 'mrfkwcrg', 'mating', 'spamroom'];
...
exports.whitelist = ['macrarazy', 'blakjack', 'naten2006'];

// Add a link to the help for the bot here. When there is a link here, .help and .guide
// will link to it.
exports.botguide = 'https://www.google.com/';
